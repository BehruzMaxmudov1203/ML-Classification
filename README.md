...
- Kirish  
- k-NN  
- Classificatorʼni baholash: Jaccard Index  
- Classificatorʼni baholash: Confusion Matrix (Precision, Recall)  
- k-NN implementation with scikit-learn  
- Selecting the best k for k-NN  
- Jupyter Notebook: k-NN  
- Portfolio project: Diabetes diagnosis  
...
- Final practice: Customer Churn prediction  
